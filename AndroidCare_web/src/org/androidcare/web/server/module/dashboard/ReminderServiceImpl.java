...
public class ReminderServiceImpl extends RemoteServiceServlet implements
	...
	public Reminder saveReminder(Reminder reminder) {
		//@comentario aunque ahora no vamos hacer nada para corregirlo, este m�todo podr�a ser usado
		//por cualquiera para a�adir cualquier recordatorio
		if(reminder.getId() > 0){
	...
	private Reminder editReminder(Reminder reminder) {
		...
		try{
			...
			//@comentario �tendr�a sentido que hacer la comprobaci�n
	...
	private Reminder saveNewReminder(Reminder reminder) {
        ...
        try {
			...
			//@comentario �deber�as usar una transacci�n para esto?
			//Pregunto, realmente no le�do todav�a nada sobre transacciones en el AppEngine,  pero parece
